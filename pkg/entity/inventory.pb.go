...
type Inventory struct {
	...
	Size_                uint64                                `protobuf:"varint,2,opt,name=Size,json=size,proto3" json:"Size,omitempty"`
	Items                map[string]uint64                     `protobuf:"bytes,3,rep,name=Items,json=items" json:"Items" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"varint,2,opt,name=value,proto3"`
...
func (*Inventory) Descriptor() ([]byte, []int) {
	return fileDescriptor_inventory_dec9717ed26abb2c, []int{0}
}
...
func NewPopulatedInventory(r randyInventory, easy bool) *Inventory {
	...
	if r.Intn(10) != 0 {
		...
		for i := 0; i < v2; i++ {
			v3 := randStringInventory(r)
			this.Items[v3] = uint64(uint64(r.Uint32()))
		}
	}
	if !easy && r.Intn(10) != 0 {
	}
...
func randFieldInventory(dAtA []byte, r randyInventory, fieldNumber int, wire int) []byte {
	...
	case 0:
		...
		dAtA = encodeVarintPopulateInventory(dAtA, uint64(v5))
	case 1:
		dAtA = encodeVarintPopulateInventory(dAtA, uint64(key))
...
func init() { proto.RegisterFile("inventory.proto", fileDescriptor_inventory_dec9717ed26abb2c) }

var fileDescriptor_inventory_dec9717ed26abb2c = []byte{
	...
	0xd1, 0xa6, 0x74, 0x89, 0x91, 0x8b, 0xd3, 0x13, 0x66, 0x94, 0x90, 0x2d, 0x17, 0x93, 0xa7, 0x8b,
	...
	0x22, 0x24, 0xc4, 0xc5, 0x12, 0x9c, 0x59, 0x95, 0x2a, 0xc1, 0xa4, 0xc0, 0xa8, 0xc1, 0x12, 0xc4,
	0x52, 0x9c, 0x59, 0x95, 0x2a, 0x64, 0xc1, 0xc5, 0xea, 0x59, 0x92, 0x9a, 0x5b, 0x2c, 0xc1, 0xac,
	0xc0, 0xac, 0xc1, 0x6d, 0x24, 0xa3, 0x07, 0x71, 0xa7, 0x1e, 0xdc, 0x52, 0x3d, 0xb0, 0xb4, 0x6b,
	0x5e, 0x49, 0x51, 0xa5, 0x13, 0x0b, 0xc8, 0xce, 0x20, 0xd6, 0x4c, 0x90, 0x88, 0x94, 0x05, 0x17,
	0x17, 0x42, 0x4a, 0x48, 0x80, 0x8b, 0x39, 0x3b, 0xb5, 0x12, 0xec, 0x36, 0xce, 0x20, 0x10, 0x53,
	0x48, 0x84, 0x8b, 0xb5, 0x2c, 0x31, 0xa7, 0x14, 0x66, 0x1d, 0x84, 0x63, 0xc5, 0x64, 0xc1, 0xe8,
	0x64, 0x71, 0xe1, 0xa1, 0x1c, 0xc3, 0x8d, 0x87, 0x72, 0x0c, 0x1f, 0x1e, 0xca, 0x31, 0xfe, 0x78,
	...
	0xa8, 0x18, 0x03, 0x02, 0x00, 0x00, 0xff, 0xff, 0x2b, 0xd4, 0xc5, 0xb1, 0x5f, 0x01, 0x00, 0x00,
}
