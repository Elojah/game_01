...
type E struct {
	...
	Trigger              github_com_elojah_game_01_pkg_ulid.ID `protobuf:"bytes,4,opt,name=Trigger,json=trigger,proto3,customtype=github.com/elojah/game_01/pkg/ulid.ID" json:"Trigger"`
...
func (*E) Descriptor() ([]byte, []int) {
	return fileDescriptor_event_08faa9d5a7be8ce1, []int{0}
}
...
func (m *E) MarshalTo(dAtA []byte) (int, error) {
	...
	dAtA[i] = 0x22
	i++
	i = encodeVarintEvent(dAtA, i, uint64(m.Trigger.Size()))
	n4, err := m.Trigger.MarshalTo(dAtA[i:])
	if err != nil {
		return 0, err
	}
	i += n4
...
func init() { proto.RegisterFile("event.proto", fileDescriptor_event_08faa9d5a7be8ce1) }

var fileDescriptor_event_08faa9d5a7be8ce1 = []byte{
	...
	,
	...
	0x6c, 0xe0, 0x00, 0x34, 0x06, 0x04, 0x00, 0x00, 0xff, 0xff, 0x91, 0x94, 0xce, 0x07, 0x93, 0x01,
	0x00, 0x00,
}
