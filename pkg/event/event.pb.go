...
type E struct {
	...
	Action  Action                                `protobuf:"bytes,3,opt,name=Action" json:"Action"`
	Trigger github_com_elojah_game_01_pkg_ulid.ID `protobuf:"bytes,4,opt,name=Trigger,proto3,customtype=github.com/elojah/game_01/pkg/ulid.ID" json:"Trigger"`
}

func (m *E) Reset()      { *m = E{} }
func (*E) ProtoMessage() {}
func (*E) Descriptor() ([]byte, []int) {
	return fileDescriptor_event_e19e012e74e27b58, []int{0}
}
...
func init() { proto.RegisterFile("event.proto", fileDescriptor_event_e19e012e74e27b58) }

var fileDescriptor_event_e19e012e74e27b58 = []byte{
	...
	0xfd, 0x82, 0xec, 0x74, 0xfd, 0xd2, 0x9c, 0xcc, 0x14, 0x3d, 0x4f, 0x97, 0x20, 0x26, 0x4f, 0x17,
	0x21, 0x67, 0x2e, 0xd6, 0x90, 0xfc, 0xec, 0xd4, 0x3c, 0x09, 0x26, 0x72, 0x4c, 0x80, 0xe8, 0x15,
	0xd2, 0xe6, 0x62, 0x73, 0x04, 0xbb, 0x4c, 0x82, 0x59, 0x81, 0x51, 0x83, 0xdb, 0x88, 0x57, 0x0f,
	0xe2, 0x57, 0x88, 0xa0, 0x13, 0x0b, 0xc8, 0xd0, 0x20, 0xa8, 0x12, 0x21, 0x77, 0x2e, 0xf6, 0x90,
	0xa2, 0xcc, 0xf4, 0xf4, 0xd4, 0x22, 0x09, 0x16, 0x72, 0xec, 0x84, 0xe9, 0x76, 0x72, 0xb8, 0xf0,
	...
	0xcb, 0x31, 0x24, 0xb1, 0x81, 0x03, 0xd2, 0x18, 0x10, 0x00, 0x00, 0xff, 0xff, 0x4d, 0x04, 0x40,
	0xbf, 0x9b, 0x01, 0x00, 0x00,
}
