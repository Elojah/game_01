...
type Trigger struct {
	EntityID      github_com_elojah_game_01_pkg_ulid.ID `protobuf:"bytes,1,opt,name=EntityID,proto3,customtype=github.com/elojah/game_01/pkg/ulid.ID" json:"EntityID"`
	EventSourceID github_com_elojah_game_01_pkg_ulid.ID `protobuf:"bytes,2,opt,name=EventSourceID,proto3,customtype=github.com/elojah/game_01/pkg/ulid.ID" json:"EventSourceID"`
	EventTargetID github_com_elojah_game_01_pkg_ulid.ID `protobuf:"bytes,3,opt,name=EventTargetID,proto3,customtype=github.com/elojah/game_01/pkg/ulid.ID" json:"EventTargetID"`
}

func (m *Trigger) Reset()      { *m = Trigger{} }
func (*Trigger) ProtoMessage() {}
func (*Trigger) Descriptor() ([]byte, []int) {
	return fileDescriptor_trigger_77939ae1227fca9d, []int{0}
}
...
func init() {
	proto.RegisterType((*Trigger)(nil), "event.Trigger")
}
func (this *Trigger) Equal(that interface{}) bool {
	...
	if !this.EventSourceID.Equal(that1.EventSourceID) {
		return false
	}
	if !this.EventTargetID.Equal(that1.EventTargetID) {
		return false
	}
	return true
}
func (this *Trigger) GoString() string {
	...
	s := make([]string, 0, 7)
	s = append(s, "&event.Trigger{")
	s = append(s, "EntityID: "+fmt.Sprintf("%#v", this.EntityID)+",\n")
	s = append(s, "EventSourceID: "+fmt.Sprintf("%#v", this.EventSourceID)+",\n")
	s = append(s, "EventTargetID: "+fmt.Sprintf("%#v", this.EventTargetID)+",\n")
	s = append(s, "}")
...
func (m *Trigger) MarshalTo(dAtA []byte) (int, error) {
	...
	dAtA[i] = 0xa
	i++
	i = encodeVarintTrigger(dAtA, i, uint64(m.EntityID.Size()))
	...
	dAtA[i] = 0x12
	i++
	i = encodeVarintTrigger(dAtA, i, uint64(m.EventSourceID.Size()))
	n2, err := m.EventSourceID.MarshalTo(dAtA[i:])
	if err != nil {
		return 0, err
	}
	i += n2
	dAtA[i] = 0x1a
	i++
	i = encodeVarintTrigger(dAtA, i, uint64(m.EventTargetID.Size()))
	n3, err := m.EventTargetID.MarshalTo(dAtA[i:])
	if err != nil {
		return 0, err
	}
	i += n3
...
func randFieldTrigger(dAtA []byte, r randyTrigger, fieldNumber int, wire int) []byte {
	...
	case 0:
		...
		dAtA = encodeVarintPopulateTrigger(dAtA, uint64(v5))
	case 1:
		dAtA = encodeVarintPopulateTrigger(dAtA, uint64(key))
...
func (m *Trigger) Size() (n int) {
	...
	l = m.EventSourceID.Size()
	n += 1 + l + sovTrigger(uint64(l))
	l = m.EventTargetID.Size()
	n += 1 + l + sovTrigger(uint64(l))
	return n
}
...
func (this *Trigger) String() string {
	...
	s := strings.Join([]string{`&Trigger{`,
		...
		`EventSourceID:` + fmt.Sprintf("%v", this.EventSourceID) + `,`,
		`EventTargetID:` + fmt.Sprintf("%v", this.EventTargetID) + `,`,
		`}`,
	}, "")
	return s
}
...
func (m *Trigger) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 2:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field EventSourceID", wireType)
			}
			var byteLen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if err := m.EventSourceID.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 3:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field EventTargetID", wireType)
			}
			var byteLen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if err := m.EventTargetID.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
...
func init() { proto.RegisterFile("trigger.proto", fileDescriptor_trigger_77939ae1227fca9d) }

var fileDescriptor_trigger_77939ae1227fca9d = []byte{
	// 258 bytes of a gzipped FileDescriptorProto
	,
	...
	0xd8, 0xc0, 0x21, 0x69, 0x0c, 0x08, 0x00, 0x00, 0xff, 0xff, 0x15, 0x4c, 0x8a, 0x8f, 0x90, 0x01,
	0x00, 0x00,
}
